    ...
    return (
        <div className={mystyle.bglanding} style={{ minHeight: "100vh" }}>
            ...
            <div style={{ marginTop: "12%" }} className='container'>
                ...
                <button onClick={landingLoading} style={{border:"none", backgroundColor: "lightblue" }} className='fw-bolder px-2 py-2 rounded d-flex align-items-center'>Get Started{loading &&
